...
const siteUrl = "https://gabu-gabu.github.io"; 
let updatedUrl = currentUrl.replace("https://gabu-gabu.github.io", "");
...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "Notícies",},{id: "news-a-long-announcement-with-details",
          title: 'A long announcement with details',
          description: "",
          section: "Notícies",handler: () => {
              window.location.href = "/news/announcement_2/";
            },},{id: "news-a-simple-inline-announcement-with-markdown-emoji-sparkles-smile",
          title: 'A simple inline announcement with Markdown emoji! :sparkles: :smile:',
          description: "",
          section: "Notícies",},{id: "projects-project-7",
          title: 'project 7',
          description: "with background image",
          section: "Projectes",handler: () => {
    ...
    {
      id: 'dark-theme',
      title: 'Canviar a tema fosc',
      description: 'Canvia a tema fosc la pàgina web',
      section: 'Tema',
      handler: () => {
    ...
    {
      id: 'system-theme',
      title: 'Utilitza el tema del sistema',
      description: 'Canvia el tema de la pàgina web pel del sistema',
      section: 'Tema',
      handler: () => {
